...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：类别管理&nbsp;&nbsp;&nbsp;&nbsp;添加新闻类别</td>
  </tr>
  <tr>
    <td align="left" valign="top">
    <form name='theform' action='NewsTypeController?nFlag=addType' method='post' onsubmit='return checkType(this);'>
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <c:if test="${not empty map && map.containsKey('typeName')}">
           <input class="text-word" type='text' name='typeName' id='typeName' value=''/>${map.typeName }<span id="msg"></span>
        </c:if>
        <c:if test="${empty map || !map.containsKey('typeName')}">
           <input class="text-word" type='text' name='typeName' id='typeName' value=''/><span id="msg"></span>
        </c:if>
        </td>
        </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input type='hidden' value='${param.nSort}' name='nSort' />
